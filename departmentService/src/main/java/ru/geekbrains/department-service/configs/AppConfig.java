package ru.geekbrains.department-service.configs;
    ...
    public WebClient userServiceWebClient(){
        TcpClient tcpClient = TcpClient
                ...
                .doOnConnected(connection -> {
                    ...
                    connection.addHandlerFirst(new WriteTimeoutHandler(cartServiceIntegrationProperties.getWriteTimeout(), TimeUnit.MILLISECONDS));
                });
